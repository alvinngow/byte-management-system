...
const Switch: React.FC<Props> = function (props) {
  ...
  return (
    <label className={classNames('relative inline-block h-6 w-12', className)}>
      ...
      <span
        className={classNames(
          ...
          "before:absolute before:left-1 before:bottom-0.5 before:h-5 before:w-5 before:rounded-full before:bg-white before:transition-colors before:content-['']",
